...
function line(obj){
	...
	// line__ = line;
	line.setGeometry_ = function(params, line__) {
	    var straightProject = utils.lnglatsToWorld(params);
		var normalized = utils.normalizeVertices(straightProject);
	    var flattenedArray = utils.flattenVectors(normalized.vertices);

		// var geometry = new THREE.LineGeometry();
		// geometry.setPositions( flattenedArray );
		// line__ = new THREE.Line2( geometry, matLine );
		// line__.position.copy(normalized.position)


		line__.geometry.setPositions(flattenedArray)
		line__.position.copy(normalized.position)
		// console.log(line__)
		line__.computeLineDistances();
		// console.log(line__)
